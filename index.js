...
*/
console.log(createMenuItem("taco", 3.5, "lunch"));
console.log(createMenuItem("burger", 7.5, "dinner"));
console.log(createMenuItem("bacon and eggs", 3.5, "breakfast"));
...
*/
reviews.push({ name: "rick", rating: 10, feedback: "It was ok" });
console.log(reviews);
/* 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 Task 5: 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 
...
function getReviewByIndex(/*Your code here*/ arr, num) {
  /*Your code here*/
...
function getLastReview(/*Your code here*/ arr) {
  /*Your code here*/
